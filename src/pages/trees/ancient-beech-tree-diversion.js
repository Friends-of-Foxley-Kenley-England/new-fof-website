...
const AncientBeechTreeIndex = ({ data, location }) => {
  ...
  return (
    <Layout location={location}>
      ...
      <p>
        In clearing the proposed route for the diversion, three badger holes
        were found adjacent to, and one directly in the route. Monitoring of
        these holes over several months, including with trail cameras, showed
        that only one is active and this is concealed behind a fallen tree.
        Advice was obtained from the East Surrey Badger Protection Society which
        has inspected the site and assisted in obtaining the necessary
        authorisation and licence from Natural England for work to take place
        adjacent to a sett.
      </p>
      <p>
      ...
      <p>
        ...
        Foxley via{" "}
        <a href="mailto:foxleygcproject@gmail.com" rel="noopener noreferrer">
      ...
      <p>
        ...
        Arboricultural Advisor for Friends of Foxley 26th Oct 2020
      </p>
    </Layout>
  );
};
